 ...
 * @author silen
 */
@WebServlet(urlPatterns = {"/editroute"})
public class editroute extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String message = "Route Successfully Updated";
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                getServletContext().getRequestDispatcher("/editroute.jsp").forward(request, response);
                return;
                //out.println(dto);
